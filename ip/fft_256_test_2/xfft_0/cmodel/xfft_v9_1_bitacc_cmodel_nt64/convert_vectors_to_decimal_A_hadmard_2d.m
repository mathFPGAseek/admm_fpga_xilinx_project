%-------------------------------------------------------------------------
%
% filename: convert_vectors_to_decimal_A_fwd_2d_fft.m
% engr: rbd
% date: 12/27/22
%
% descr:
...
% Import Table
hadmardAforward2dmemrawvectors = importfile("C:\design\phd_ee\fall_2022_fpga_accel_fista_lenless_camera\fista_fpga_matlab\debug_1d_fft\admm_fpga_xilinx_project\ip\fft_256_test_2\xfft_0\cmodel\xfft_v9_1_bitacc_cmodel_nt64\hadmard_A_forward_2d_mem_raw_vectors.txt", [1, Inf]);
size_string = size(hadmardAforward2dmemrawvectors,1);

% Split into Real and Imag Strings
[StringSplitArrayImagOut, StringSplitArrayRealOut] = SplitStringArray(hadmardAforward2dmemrawvectors,fixed_point_length,size_string);
...
function fftAforward2dmemrawvectors = importfile(filename, dataLines)
%IMPORTFILE Import data from a text file
%  FFTAFORWARD2DMEMRAWVECTORS = IMPORTFILE(FILENAME) reads data from
%  text file FILENAME for the default selection.  Returns the data as a
%  string array.
%
%  FFTAFORWARD2DMEMRAWVECTORS = IMPORTFILE(FILE, DATALINES) reads data
%  for the specified row interval(s) of text file FILENAME. Specify
%  DATALINES as a positive scalar integer or a N-by-2 array of positive
%  scalar integers for dis-contiguous row intervals.
%
%  Example:
%  fftAforward2dmemrawvectors = importfile("C:\design\phd_ee\fall_2022_fpga_accel_fista_lenless_camera\fista_fpga_matlab\debug_1d_fft\admm_fpga_xilinx_project\ip\fft_256_test_2\xfft_0\cmodel\xfft_v9_1_bitacc_cmodel_nt64\fft_A_forward_2d_mem_raw_vectors.txt", [1, Inf]);
%
%  See also READMATRIX.
%
% Auto-generated by MATLAB on 27-Dec-2022 15:48:38
...
% Import the data
fftAforward2dmemrawvectors = readmatrix(filename, opts);
