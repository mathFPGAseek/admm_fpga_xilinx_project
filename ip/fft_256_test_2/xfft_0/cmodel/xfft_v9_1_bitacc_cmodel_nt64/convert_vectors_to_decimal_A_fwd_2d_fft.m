...
size_string = size(fftAforward2dmemrawvectors,1);

% Split into Real and Imag Strings
[StringSplitArrayImagOut, StringSplitArrayRealOut] = SplitStringArray(fftAforward2dmemrawvectors,fixed_point_length,size_string);
